...
export const Timeline = ({ data, header }: { data: TimelineEntry[], header: any }) => {
  ...
  return (
    <div
      className="w-full  md:px-10 pt-6"
      ref={containerRef}
    >
      <div ref={ref} className="relative max-w-7xl mx-auto p-4">
        {data.map((item, index) => (
          <div
            key={index}
