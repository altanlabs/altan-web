...
export default function TestimonialsCarousel() {
  const { t } = useTranslation(["common", "home", "home:altaners"]);

  const carouselItems = [
    {
      image: CarouselImg01,
      title: t("home:altaners.enhancedWorkflowCapacity"),
      description: t("home:altaners.enhancedWorkflowDescription"),
      link: "#0",
    },
    {
      image: CarouselImg02,
      title: t("home:altaners.aiPoweredAgents"),
      description: t("home:altaners.aiPoweredAgentsDescription"),
      link: "#0",
    },
    {
      image: CarouselImg03,
      title: t("home:altaners.robustDynamicTables"),
      description: t("home:altaners.robustDynamicTablesDescription"),
      link: "#0",
    },
    {
      image: CarouselImg04,
      title: t("home:altaners.intuitiveFormsAndUI"),
      description: t("home:altaners.intuitiveFormsAndUIDescription"),
      link: "#0",
    },
    {
      image: CarouselImg05,
      title: t("home:altaners.unifiedNavigation"),
      description: t("home:altaners.unifiedNavigationDescription"),
      link: "#0",
    },
  ]
        ...
        <div className="pt-12 md:pt-20">
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <div>
              <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-purple-200 pb-3">
                {t("home:altaners.automatedSolutionEnhanced")}
              </div>
            </div>
            <h2 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">
              {t("home:altaners.goBeyondWorkflows")}
            </h2>
            <p className="text-lg text-slate-400">
              {t("home:altaners.combinedFeaturesDescription")}
            </p>
          </div>
            ...
            <div className="altan-carousel swiper-container group">
              <Highlighter className="swiper-wrapper w-fit" refresh={swiperInitialized}>
                {carouselItems.map((item, index) => (
                  <HighlighterItem key={index} className="swiper-slide h-auto group/slide">
                    <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                      ...
                      <div className="flex flex-col p-6 h-full">
                        <Image className="mb-3" src={item.image} width={56} height={56} alt={item.title} />
                        <div className="grow">
                          <div className="font-bold text-lg mb-1">{item.title}</div>
                          <div className="text-slate-400 mb-3">{item.description}</div>
                        </div>
                        {/* <div className="text-right">
                          <a className="text-sm font-medium text-slate-300 hover:text-white inline-flex items-center transition duration-150 ease-in-out group" href={item.link}>
                            {t("home:altaners.learnMore")} <span className="tracking-normal text-purple-500 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">-&gt;</span>
                          </a>
                        </div> */}
                      </div>
                    </div>
          ...
          <div className="flex mt-8 justify-end">
            <button className="carousel-prev relative z-20 w-12 h-12 flex items-center justify-center group">
              <span className="sr-only">{t("home:altaners.previous")}</span>
            ...
            <button className="carousel-next relative z-20 w-12 h-12 flex items-center justify-center group">
              <span className="sr-only">{t("home:altaners.next")}</span>
              <svg className="w-4 h-4 fill-slate-500 group-hover:fill-purple-500 transition duration-150 ease-in-out" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
