export default function Features04({ locale }) {
  return (
        ...
        <div className="pt-16 pb-12 md:pt-32 md:pb-20">
          ...
          <div className="max-w-3xl pb-12 md:pb-20">
            ...
            <p className="text-lg text-slate-400">
              Getting Started with Altan is Simple.
            </p>
          </div>

          {/* Rows */}
          <div className="divide-y divide-slate-800">
            {/* Row: Design Your Altaner */}
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Drag-and-Drop Builder</h4>
                  </div>
                  <p className="text-sm text-slate-400">Easily add workflows, forms, and AI agents to create powerful automations without any code.</p>
                </div>
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    <svg className="shrink-0 fill-slate-300" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
                    ...
                    <h4 className="font-medium text-slate-50">Automated UI Generation</h4>
                  </div>
                  <p className="text-sm text-slate-400">Watch as Altan builds your UI components, bringing your app to life as you design.</p>
                </div>
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    <svg className="shrink-0 fill-slate-300" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
                    ...
                    <h4 className="font-medium text-slate-50">Flexible Components</h4>
                  </div>
                  <p className="text-sm text-slate-400">Customize forms, workflows, and AI agents to fit any use case.</p>
                </div>
              </div>
            </div>

            {/* Row: Set Your Monetization Model */}
            <div className="py-8">
              <div>
                <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-purple-200 pb-6">Set Your Monetization Model</div>
              </div>
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Recurring Subscriptions</h4>
                  </div>
                  <p className="text-sm text-slate-400">Set up recurring payments for ongoing Altaner usage, turning your automations into revenue-generating assets.</p>
                </div>
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    <svg className="shrink-0 fill-slate-300" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
                    ...
                    <h4 className="font-medium text-slate-50">One-Time Payments</h4>
                  </div>
                  <p className="text-sm text-slate-400">Offer single-purchase options for unique projects or custom Altaners.</p>
                </div>
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    <svg className="shrink-0 fill-slate-300" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
                    ...
                    <h4 className="font-medium text-slate-50">Custom Pricing</h4>
                  </div>
                  <p className="text-sm text-slate-400">Control how you charge by defining prices for unique workflows, Altaner features, and resource usage.</p>
                </div>
              </div>
            </div>

            {/* Row: Launch and Scale */}
            <div className="py-8">
              <div>
                <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-purple-200 pb-6">Launch and Scale</div>
              </div>
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Instant Deployment</h4>
                  </div>
                  <p className="text-sm text-slate-400">Launch your Altaner in minutes and start seeing results immediately.</p>
                </div>
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    <svg className="shrink-0 fill-slate-300" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
                    ...
                    <h4 className="font-medium text-slate-50">Scalable Infrastructure</h4>
                  </div>
                  <p className="text-sm text-slate-400">Our platform is ready to scale as your client base grows.</p>
                </div>
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    <svg className="shrink-0 fill-slate-300" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
                    ...
                    <h4 className="font-medium text-slate-50">Real-Time Analytics</h4>
                  </div>
                  <p className="text-sm text-slate-400">Get insights into performance and engagement, allowing you to optimize and scale.</p>
                </div>
              </div>
            </div>
